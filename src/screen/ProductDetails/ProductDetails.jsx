...
class ProductDetailsComponent extends React.PureComponent {
  constructor(props) {
    ...
    this.state = {
      ...
      props: {
        ...
        img:
          "https://w7.pngwing.com/pngs/285/672/png-transparent-hotel-hotel-dishes-roumo-ti-hua-food-recipe-cuisine.png",
      },
    };
  }
  componentDidMount() {
  ...
  render() {
    return (
      <Base>
        <InnerHeader title="Product Detail" />
              ...
              <Col lg={5}>
                <div className="text">
                  ...
                  <h6 className="fw600 barlow">
                    <span className="discountPrice">$30</span>{" "}
                  ...
                  <p>
                    Neque porro quisquam est aui dolorem iesum ruia do it amet,
                    consectetur, adipisci velit, sed quia non num eius modi
                    tempora incidunt ut labore et dolore magna volutatem
                    exercitationem ullam.
                  </p>
                  <h5 className="fw500 jost d-flex">
                    Share:
                    ...
                    <Tab.Content>
                      <Tab.Pane eventKey="first">
                        <p>
                          ...
                          elit. Rerum pariatur sint error sapiente odit veniam
                          accusamus doloribus quis quia ratione earum neque
                          eius, quos beatae alias animi quas perspiciatis!
                          Dignissimos.
                        </p>
                      </Tab.Pane>
                      <Tab.Pane eventKey="second">
                        <p>
                          ...
                          adipisicing elit. Explicabo, accusantium. Optio
                          praesentium nostrum aut quae!
                        </p>
                      </Tab.Pane>
                      <Tab.Pane eventKey="three">
                        <p>
                          ...
                          eius, quos beatae alias animi quas perspiciatis!
                          Dignissimos. Lorem ipsum dolor, sit amet consectetur
                          adipisicing elit. Accusamus autem doloremque sed ipsum
                          cupiditate. Minima error eos saepe dolor nam.
                        </p>
                      </Tab.Pane>
                    </Tab.Content>
                  </Tab.Container>
